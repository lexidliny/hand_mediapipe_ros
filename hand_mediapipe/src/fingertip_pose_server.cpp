...
class PoseServer
{
  ...
  ros::ServiceServer service = n.advertiseService<hand_mediapipe::FingerTipPose>("fingertip_pose_server",get_fingertip_pose);
  ...
  bool get_fingertip_pose(hand_mediapipe::FingerTipPoseRequest &req, hand_mediapipe::FingerTipPoseResponse &res)
  {
    ...
    ny = {landmark_points[0].x - landmark_points[1].x, 
          ...
          landmark_points[0].z - landmark_points[1].z};
    ...
    t_homo[0] = landmark_points[0].x * nz[0] * 0.1;
    t_homo[1] = landmark_points[0].y * nz[1] * 0.1;
    t_homo[2] = landmark_points[0].z * nz[2] * 0.1;
    t_homo[3] = 1.;
