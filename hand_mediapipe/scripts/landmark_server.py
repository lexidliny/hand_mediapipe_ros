  ...
  with mp_hands.Hands(
    ...
    while True:
      ...
      for hand_landmarks in results.multi_hand_landmarks:
          ...
          middle_dip_pix_x = hand_landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_DIP].x *image_width
          middle_dip_pix_y = hand_landmarks.landmark[mp_hands.HandLandmark.MIDDLE_FINGER_DIP].y *image_height
          ...
          landmarks = [(middle_tip_pix_x, middle_tip_pix_y), 
                       (middle_dip_pix_x, middle_dip_pix_y),
